\subsection{A solução}
  ...
  \subsubsection{Criar conta}
    ...
    Há subsídios suficientes para elencarmos os cenários\footnote{\cite{Adzic2011}} a serem trabalhados (\textbf{Figura \ref{fig:criar-conta.cenarios}}).
