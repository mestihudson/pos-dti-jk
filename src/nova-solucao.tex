\subsection{A solução}
  ...
  Essa estrutura permite testar os componentes e páginas, novamente, de forma isolada (\figref{teste-de-unidade-de-pagina-registro}), ao passo que são resguardados pelos testes de aceitação.

  \begin{figure}[h]
    \centering
    \caption{Teste de unidade da página de registro e respectiva solução}
    \efbox{
      \makebox[\textwidth]{
        \begin{subfigure}[t]{0.5\textwidth}
          \centering
