\subsection{A solução}
  ...
  Sem muito esforço cognitivo chegamos aos seguintes trechos de código da solução: frontend (\figref{solucao.frontend}); backend (\figref{solucao.backend}); e, banco de dados (\figref{solucao.db}).
