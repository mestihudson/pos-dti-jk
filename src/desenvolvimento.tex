...
\section{Trabalhos relacionados}
  ...
  \citeonline{Adhikari2019} inicia lembrando outra conhecida denominação do TDD - \emph{Test-First} (testar primeiro, em tradução livre), e que a mesma é um importante componente em metodologias largamente adotadas atualmente - ágil, lean, xp, etc. Decreta, ainda, que é uma filosofia de desenho de sistemas que tenta descobrir defeitos no software de forma mais antecipada possível. Observa que muitos praticantes tem utilizado a mesma de maneira empírica em função de seu apelo, mas que só mais recentemente a técnica tem ganhado abordagens conceituais mais sistemáticas. O trabalho é uma pesquisa das técnicas desenvolvidas e formalizadas na década de 2010-2019, indo desde testes de unidade, passando por testes de regressão e indo até os mais recentes conceitos de teste contínuo, onde são avaliados armadilhas em potencial de diferentes jeitos de se realizar o TDD, principalmente quando o escopo e o número de contribuidores do projeto aumenta.

  \citeonline{Benato2021} atribui o ganho de notoriedade de TDD ao fato de ter sido atrelado, de maneira essencial, ao Extreme Programming, por Kent Beck. Nesse trabalho, os autores apresentam uma análise dos experimentos e conclusões de estudos, com relação aos efeitos do TDD na produtividade dos desenvolvedores e na qualidade dos software produzido, contrapondo as técnicas de \emph{test-first} e \emph{test-last}. É realizada uma revisão bibliográfica sistemática de artigos publicados entre 2003 e 2020. Tal análise concluiu que 54\% dos estudos apontam um aumento considerável na qualidade do software produzido, ao passo que nenhum deles conseguiu demonstrar queda na qualidade. Também encontraram que 27\% apontaram diminuição na produtividade e outros 27\% foram inconclusivos. Os autores terminam por não terem uma posição final sobre o custo-benefício do uso do TDD.

  \citeonline{Beltrao2020} salientam que os termos dívida técnica - DT - e gestão de dívida técnica têm recebido cada vez mais atenção de praticantes e pesquisadores. Afirmam que isso reflete a preocupação de como os atalhos tomados durante o processo de desenvolvimento de um software pode culminar em efeitos nocivos para a manutenibilidade e como os desenvolvedores podem fazer uso de ferramental e técnicas para minimizar os prejuízos advindos dessa decisão de projeto ao longo do tempo. Lembram que o SonarQube é uma dessas ferramentas, amplamente adotada, e que mesmo sendo um padrão de-facto, ele possui suas fraquezas, pois só apresenta um conjunto de regras agnósticas para o gerenciamentos de DT e que a implementação de novas regras pode ser um trabalho bastante desafiador. O trabalho discute como, durante um projeto real, em uma \emph{software house} no Brasil, foi desenvolvido um conjunto de novas regras baseadas em modelo de \emph{Arquitetura Limpa} e um plugin para o SonarQube, bem como foi integrado ao ciclo de desenvolvimento.
